...
def main():
    parser = argparse.ArgumentParser(description="Copy SVG files while preserving a streamlined directory structure.")
    parser.add_argument("base_dir", help="Base directory to search for SVG files")
